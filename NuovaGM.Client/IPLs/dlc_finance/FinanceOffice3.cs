...
namespace NuovaGM.Client.IPLs.dlc_finance
{
	public class FinanceOffice3
	{
		...
		public class OfficeFinanceStyle
		{
			...
			public Theme Warm = new Theme(240897, "ex_sm_13_office_01a", "ex_prop_safedoor_office1a");
            public Theme Classical = new Theme(241153, "ex_sm_13_office_01b", "ex_prop_safedoor_office1b");
            public Theme Vintage = new Theme(241409, "ex_sm_13_office_01c", "ex_prop_safedoor_office1c");
            public Theme Contrast = new Theme(241665, "ex_sm_13_office_02a", "ex_prop_safedoor_office2a");
            public Theme Rich = new Theme(241921, "ex_sm_13_office_02b", "ex_prop_safedoor_office2a");
            public Theme Cool = new Theme(242177, "ex_sm_13_office_02c", "ex_prop_safedoor_office2a");
            public Theme Ice = new Theme(242433, "ex_sm_13_office_03a", "ex_prop_safedoor_office3a");
            public Theme Conservative = new Theme(242689, "ex_sm_13_office_03b", "ex_prop_safedoor_office3a");
            public Theme Polished = new Theme(242945, "ex_sm_13_office_03c", "ex_prop_safedoor_office3c");
		...
		{
			public float DoorHeadingL = 126f;
			public Vector3 Position = new Vector3(-1554.08f, -573.7122f, 108.5272f);
		...
		public static FinanceOffice3 Instance;

		public static void LoadDefault()
		{
			Style.Set(Style.Warm);
			Chairs.Set(Chairs.On, true);
			Instance = new FinanceOffice3();
		}
	}
}
