...
namespace NuovaGM.Client.IPLs.dlc_finance
{
	public class FinanceOffice2
	{
		...
		public class OfficeFinanceStyle
		{
			...
			public Theme Warm = new Theme(238593, "ex_dt1_11_office_01a", "ex_prop_safedoor_office1a");
            public Theme Classical = new Theme(238849, "ex_dt1_11_office_01b", "ex_prop_safedoor_office1b");
            public Theme Vintage = new Theme(239105, "ex_dt1_11_office_01c", "ex_prop_safedoor_office1c");
            public Theme Contrast = new Theme(239361, "ex_dt1_11_office_02a", "ex_prop_safedoor_office2a");
            public Theme Rich = new Theme(239617, "ex_dt1_11_office_02b", "ex_prop_safedoor_office2a");
            public Theme Cool = new Theme(239873, "ex_dt1_11_office_02c", "ex_prop_safedoor_office2a");
            public Theme Ice = new Theme(240129, "ex_dt1_11_office_03a", "ex_prop_safedoor_office3a");
            public Theme Conservative = new Theme(240385, "ex_dt1_11_office_03b", "ex_prop_safedoor_office3a");
            public Theme Polished = new Theme(240641, "ex_dt1_11_office_03c", "ex_prop_safedoor_office3c");
		...
		{
			public float DoorHeadingL = 250f;
			public Vector3 Position = new Vector3(-82.593f, -801.0f, 243.385f);
		...
		public static FinanceOffice2 Instance;

		public static void LoadDefault()
		{
			Style.Set(Style.Warm);
			Chairs.Set(Chairs.On, true);
			Instance = new FinanceOffice2();
		}
	}
}
