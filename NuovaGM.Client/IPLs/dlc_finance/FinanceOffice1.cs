...
namespace NuovaGM.Client.IPLs.dlc_finance
{
	public class FinanceOffice1
	{
		...
		public class OfficeFinanceStyle
		{
			...
			public Theme Warm = new Theme(236289, "ex_dt1_02_office_01a", "ex_prop_safedoor_office1a");
            public Theme Classical = new Theme(236545, "ex_dt1_02_office_01b", "ex_prop_safedoor_office1b");
            public Theme Vintage = new Theme(236801, "ex_dt1_02_office_01c", "ex_prop_safedoor_office1c");
            public Theme Contrast = new Theme(237057, "ex_dt1_02_office_02a", "ex_prop_safedoor_office2a");
            public Theme Rich = new Theme(237313, "ex_dt1_02_office_02b", "ex_prop_safedoor_office2a");
            public Theme Cool = new Theme(237569, "ex_dt1_02_office_02c", "ex_prop_safedoor_office2a");
            public Theme Ice = new Theme(237825, "ex_dt1_02_office_03a", "ex_prop_safedoor_office3a");
            public Theme Conservative = new Theme(238081, "ex_dt1_02_office_03b", "ex_prop_safedoor_office3a");
            public Theme Polished = new Theme(238337, "ex_dt1_02_office_03c", "ex_prop_safedoor_office3c");

			public OfficeFinanceStyle()
			{
				ThemeInternal.Add(Warm);
				ThemeInternal.Add(Classical);
				ThemeInternal.Add(Vintage);
				ThemeInternal.Add(Contrast);
				ThemeInternal.Add(Rich);
				ThemeInternal.Add(Cool);
				ThemeInternal.Add(Ice);
				ThemeInternal.Add(Conservative);
				ThemeInternal.Add(Polished);
			}
		...
		{
			public float DoorHeadingL = 96f;
			public Vector3 Position = new Vector3(-124.25f, -641.30f, 168.870f);
...
//				else
		...
		public static FinanceOffice1 Instance;

		public static void LoadDefault()
		{
			Style.Set(Style.Warm);
			Chairs.Set(Chairs.On, true);
			Instance = new FinanceOffice1();
		}
	}
}
