...
namespace NuovaGM.Client.IPLs.dlc_doomsday
{
	public class DoomsdayFacility
	{
		...
		public class DInterior
		{
			...
			public bool Enabled
			{
				...
				set
				{
					...
					IplManager.SetIplPropState(InteriorId, "set_int_02_shell", true, true);
				}
			}
		}
		...
		public class DWalls
		{
			...
			{
				API.SetInteriorEntitySetColor(InteriorId, "set_int_02_shell", (int)color);
		...
		public class DDecals
		{
			...
			{
				IplManager.SetIplPropState(InteriorId, new List<string>() { "set_int_02_decal_01", "set_int_02_decal_02", "set_int_02_decal_03", "set_int_02_decal_04", "set_int_02_decal_05", "set_int_02_decal_06", "set_int_02_decal_07", "set_int_02_decal_08", "set_int_02_decal_09" }, false, refresh);
			}
		}
		...
		public class DLounge
		{
			...
			public void Set(string lounge, Colors color, bool refresh = true)
			{
				Clear(false);
				IplManager.SetIplPropState(InteriorId, lounge, true, refresh);
				API.SetInteriorEntitySetColor(InteriorId, lounge, (int)color);
			}
			public void Clear(bool refresh)
			{
				IplManager.SetIplPropState(InteriorId, new List<string>() { "set_int_02_lounge1", "set_int_02_lounge2", "set_int_02_lounge3" }, false, refresh);
			}
		}
		...
		public class DSleeping
		{
			...
			public void Set(string sleep, Colors color, bool refresh = true)
			{
				Clear(false);
				IplManager.SetIplPropState(InteriorId, sleep, true, refresh);
				API.SetInteriorEntitySetColor(InteriorId, sleep, (int)color);
			}
			public void Clear(bool refresh)
			{
				IplManager.SetIplPropState(InteriorId, new List<string>() { "set_int_02_sleep", "set_int_02_sleep2", "set_int_02_sleep3" }, false, refresh);
			}
		}
		...
		public class DSecurity
		{
			...
			public void Set(string security, Colors color, bool refresh = true)
			{
				Clear(false);
				IplManager.SetIplPropState(InteriorId, security, true, refresh);
				API.SetInteriorEntitySetColor(InteriorId, security, (int)color);
			}
			public void Clear(bool refresh)
			{
				IplManager.SetIplPropState(InteriorId, new List<string>() { "set_int_02_no_security", "set_int_02_security" }, false, refresh);
			}
		}
		public class DCannon
		{
			...
			public void Clear(bool refresh)
			{
				IplManager.SetIplPropState(InteriorId, new List<string>() { "set_int_02_no_cannon", "set_int_02_cannon" }, false, refresh);
			}
		}
		...
		public class DPrivacyGlass
		{
			...
			public class PGBedRoom
			{
				...
				public class Controls
				{
					...
					public async void Enable(bool state)
					{
						int handle = API.GetClosestObjectOfType(Position.X, Position.Y, Position.Z, 1.0f, (uint)ControlModelHash, false, false, false);

						if (state)
						{
							if (handle == 0)
							{
								API.RequestModel((uint)ControlModelHash);
								while (!API.HasModelLoaded((uint)ControlModelHash)) await BaseScript.Delay(0);

								int PrivacyGlass = API.CreateObjectNoOffset((uint)ControlModelHash, Position.X, Position.Y, Position.Z, true, true, false);
		...
		public class DDetails
		{
			...
			public class Trophiess
			{
				...
				public void Set(string trofeo, Colors color, bool refresh = true)
				{
					Clear(false);
					IplManager.SetIplPropState(InteriorId, trofeo, true, refresh);
					API.SetInteriorEntitySetColor(InteriorId, trofeo, (int)color);
				}
				public void Clear(bool refresh)
				{
					IplManager.SetIplPropState(InteriorId, new List<string>() { "set_int_02_trophy1", "set_int_02_trophy_iaa", "set_int_02_trophy_sub" }, false, refresh);
				}
				public void SetColor(Colors color, bool refresh = true)
				{
					API.SetInteriorEntitySetColor(InteriorId, "set_int_02_trophy_sub", (int)color);
					if (refresh) API.RefreshInterior(InteriorId);
				}
			}
		...
		public static DInterior Interior = new DInterior();
		public static DExterior Exterior = new DExterior();
		public static DWalls Walls = new DWalls();
		public static DDecals Decals = new DDecals();
		public static DLounge Lounge = new DLounge();
		public static DSleeping Sleeping = new DSleeping();
		public static DSecurity Security = new DSecurity();
		public static DCannon Cannon = new DCannon();
		public static DPrivacyGlass PrivacyGlass = new DPrivacyGlass();
		...
		public static void LoadDefault()
		{
			...
			Walls.SetColor(Colors.Utility);
			Decals.Set(Decals.style01);
			Lounge.Set(Lounge.Premier, Colors.Utility);
			Sleeping.Set(Sleeping.Premier, Colors.Utility);
			Security.Set(Security.On, Colors.Utility);
			Cannon.Set(Cannon.On, Colors.Utility);
			...
			Details.Trophies.SetColor(Colors.Utility);
