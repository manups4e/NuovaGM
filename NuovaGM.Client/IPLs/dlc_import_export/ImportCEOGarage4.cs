...
namespace NuovaGM.Client.IPLs.dlc_import_export
{
	public class ImportCEOGarage4
	{
		public class GaragePart
		{
			...
			public Garage Garage1 = new Garage(256513, "imp_sm_15_cargarage_a");
			public Garage Garage2 = new Garage(256769, "imp_sm_15_cargarage_b");
			public Garage Garage3 = new Garage(257025, "imp_sm_15_cargarage_c");
			public Garage ModShop = new Garage(257281, "imp_sm_15_modgarage");
