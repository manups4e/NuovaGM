...
namespace TheLastPlanet.Client.IPLs.dlc_import_export
{
	public class ImportCEOGarage2
	{
		public class GaragePart
		{
			...
			public Garage Garage1 = new Garage(254465, "imp_dt1_11_cargarage_a");
			public Garage Garage2 = new Garage(254721, "imp_dt1_11_cargarage_b");
			public Garage Garage3 = new Garage(254977, "imp_dt1_11_cargarage_c");
			public Garage ModShop = new Garage(255233, "imp_dt1_11_modgarage");
