...
namespace TheLastPlanet.Client.IPLs.dlc_bikers
{
	public class BikerCounterfeit
	{
		...
		public static string ipl = "bkr_biker_interior_placement_interior_5_biker_dlc_int_ware04_milo";
		...
		public class CounterfaitPrinter
		{
			...
			public void Set(string printer, bool refresh = true)
			{
				Clear(false);
				if (printer != None)
					IplManager.SetIplPropState(InteriorId, printer, true, refresh);
				else
				{
			...
			{
				IplManager.SetIplPropState(InteriorId, new List<string>() { "counterfeit_standard_equip_no_prod", "counterfeit_standard_equip", "counterfeit_upgrade_equip_no_prod", "counterfeit_upgrade_equip" }, false, refresh);
			}
		}
		...
		public class CounterfaitDryer
		{
			...
			{
				if (onoff != None)
					IplManager.SetIplPropState(InteriorId, onoff, true, refresh);
				else
				{
					if (refresh) API.RefreshInterior(InteriorId);
				}
		...
		public static CounterfaitPrinter Printer = new CounterfaitPrinter();
		public static CounterfaitSecurity Security = new CounterfaitSecurity();
		public static CounterfaitDryer Dryer1 = new CounterfaitDryer("dryera_on", "dryera_off", "dryera_open");
		public static CounterfaitDryer Dryer2 = new CounterfaitDryer("dryerb_on", "dryerb_off", "dryerb_open");
		public static CounterfaitDryer Dryer3 = new CounterfaitDryer("dryerc_on", "dryerc_off", "dryerc_open");
		public static CounterfaitDryer Dryer4 = new CounterfaitDryer("dryerd_on", "dryerd_off", "dryerd_open");
		public static CounterfaitDetails Details = new CounterfaitDetails();
