...
namespace NuovaGM.Client.IPLs.dlc_executive
{
	public class ExecApartment1
	{
		public class StyleExec
		{
			public class ExecApartTheme
			{
				...
				public static Theme Modern = new Theme(227329, "apa_v_mp_h_01_a");
				public static Theme Moody = new Theme(228097, "apa_v_mp_h_02_a");
				public static Theme Vibrant = new Theme(228865, "apa_v_mp_h_03_a");
				public static Theme Sharp = new Theme(229633, "apa_v_mp_h_04_a");
				public static Theme Monochrome = new Theme(230401, "apa_v_mp_h_05_a");
				public static Theme Seductive = new Theme(231169, "apa_v_mp_h_06_a");
				public static Theme Regal = new Theme(231937, "apa_v_mp_h_07_a");
				public static Theme Aqua = new Theme(232705, "apa_v_mp_h_08_a");
