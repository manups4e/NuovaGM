...
namespace NuovaGM.Client.gmPrincipale.MenuGm
{
	static class Menus
	{
		...
		static List<dynamic> blemishes = new List<dynamic>() { GetLabelText("NONE"), GetLabelText("0xE7D7ECEB"), GetLabelText("0x6214E163"), GetLabelText("0x342D0594"), GetLabelText("0x457F2838"), GetLabelText("0x17D04CDB"), GetLabelText("0xAAEE7315"), GetLabelText("0x7D3497A2"), GetLabelText("0x8ECABACE"), GetLabelText("0x51FE4136"), GetLabelText("0xD447C5CF"), GetLabelText("0xE950A12C"), GetLabelText("0xDB7B0581"), GetLabelText("0xD60AFAA1"), GetLabelText("0xC540590C"), GetLabelText("0xB267335A"), GetLabelText("0xA3D59637"), GetLabelText("0x9331F4EC"), GetLabelText("0x6CFAA87E"), GetLabelText("0x5FB40DF1"), GetLabelText("0x4965E155"), GetLabelText("0x105A709F"), GetLabelText("0xFE1C4C23"), GetLabelText("0xEFFDAFE6"), GetLabelText("0xDDC90B7D") };
		static List<dynamic> Ageing = new List<dynamic>() { GetLabelText("NONE"), GetLabelText("0x18D933DD"), GetLabelText("0x0B0B1841"), GetLabelText("0x007F032D"), GetLabelText("0x32D4E7D8"), GetLabelText("0x2403CA36"), GetLabelText("0x5632AE93"), GetLabelText("0x476290F3"), GetLabelText("0x79A47576"), GetLabelText("0x6ADDD7E9"), GetLabelText("0x9D283C7D"), GetLabelText("0x7B3CFDB3"), GetLabelText("0x6BA15E7C"), GetLabelText("0x4DC822CA")/*0x808546ED*/, GetLabelText("0x40038741"), GetLabelText("0xB2466BC5") };
		static List<dynamic> Complexions = new List<dynamic>() { GetLabelText("NONE"), GetLabelText("0xB985495B"), GetLabelText("0xCB42ECD6"), GetLabelText("0x948AFF73"), GetLabelText("0x1D5210F7"), GetLabelText("0x5808066E"), GetLabelText("0x82CF5BFC"), GetLabelText("0xF040837C"), GetLabelText("0xDC160E80"), GetLabelText("0x2F74B53C"), GetLabelText("0x39ABC9AA"), GetLabelText("0x130D9107"), GetLabelText("0x3074CBD5") };
		static List<dynamic> Nei_e_Porri = new List<dynamic>() { GetLabelText("NONE"), GetLabelText("0x50DD40E2"), GetLabelText("0x702A7F7C"), GetLabelText("0x7E621BEB"), GetLabelText("0xF07A0031"), GetLabelText("0xE3126562"), GetLabelText("0x1DD7DAEC"), GetLabelText("0x0F973E6B"), GetLabelText("0xAB9E767B"), GetLabelText("0x9D7D5A39"), GetLabelText("0xD4924862"), GetLabelText("0x1675997A"), GetLabelText("0x3BFEE48C"), GetLabelText("0xF2C2D215"), GetLabelText("0x28813D91"), GetLabelText("0xEA7CC185"), GetLabelText("0x204B2D21"), GetLabelText("0xD73A1B00"), GetLabelText("0xFD0D66A6") };
		static List<dynamic> Danni_Pelle = new List<dynamic>() { GetLabelText("NONE"), GetLabelText("0x1BC55A85"), GetLabelText("0x2CFEFCF8"), GetLabelText("0x49E96A25"), GetLabelText("0x015325A1") /*rough 0xC6C5F9B8*/, GetLabelText("0xD2BBC873"), GetLabelText("0xB7E292C1"), GetLabelText("0xC729314E"), GetLabelText("0x9BC2DA6A"), GetLabelText("0xADA27E29"), GetLabelText("0x6F8501EF"), GetLabelText("0x9040D190") };
