...
{
	class ConfigBarbieri
	{
		public static List<NegozioBarbiere> Kuts = new List<NegozioBarbiere>
		{
			new NegozioBarbiere(new Vector3(-279.154f, 6226.192f, 31.705f), new BarberModel("a_m_y_stbla_02", "S_M_M_HAIRDRESSER_01_BLACK_MINI_01", new Vector4(-278.205f, 6230.279f, 31.696f, 49.216f)), new Vector3(-278.4f, 6225.8f, 31.58f), new Vector3(-279.59f, 6226.81f, 31.58f), new Vector3(-280.61f, 6227.88f, 31.58f), 133.69f, new Vector3(0, -1.8391f, -0.1795f), 313.69f),
			new NegozioBarbiere(new Vector3(1211.0759277344f, -475.00064086914f, 66.218032836914f), new BarberModel("a_m_y_stbla_02", "S_M_M_HAIRDRESSER_01_BLACK_MINI_01", new Vector4(1211.521f, -470.704f, 66.208f, 79.543f)), new Vector3(1213.38f, -474.84f, 66.0f), new Vector3(1211.9f, -474.54f, 66.0f), new Vector3(1210.45f, -474.14f, 66.0f), 163.6f, new Vector3(0, -1.8391f, -0.1795f), 343.6f),
			new NegozioBarbiere(new Vector3(139.21583557129f, -1708.9689941406f, 29.301620483398f), new BarberModel("s_f_m_fembarber", "S_F_M_FEMBARBER_BLACK_MINI_01", new Vector4(-278.205f, 6230.279f, 31.696f, 49.216f)), new Vector3(-278.4f, 6225.8f, 31.58f), new Vector3(-279.59f, 6226.81f, 31.58f), new Vector3(-280.61f, 6227.88f, 31.58f), 226.24f, new Vector3(1.0109f, -0.8391f, -0.1795f), 0)
		};
