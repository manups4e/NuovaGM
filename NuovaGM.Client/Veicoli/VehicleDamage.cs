...
namespace NuovaGM.Client.Veicoli
{
	static class VehicleDamage
	{
		...
		{
			deformationMultiplier = ConfigClient.Conf.Veicoli.DanniVeicoli.deformationMultiplier;
			deformationExponent = ConfigClient.Conf.Veicoli.DanniVeicoli.deformationExponent;
			collisionDamageExponent = ConfigClient.Conf.Veicoli.DanniVeicoli.collisionDamageExponent;
			damageFactorEngine = ConfigClient.Conf.Veicoli.DanniVeicoli.damageFactorEngine;
			damageFactorBody = ConfigClient.Conf.Veicoli.DanniVeicoli.damageFactorBody;
			damageFactorPetrolTank = ConfigClient.Conf.Veicoli.DanniVeicoli.damageFactorPetrolTank;
			engineDamageExponent = ConfigClient.Conf.Veicoli.DanniVeicoli.engineDamageExponent;
			weaponsDamageMultiplier = ConfigClient.Conf.Veicoli.DanniVeicoli.weaponsDamageMultiplier;
			degradingHealthSpeedFactor = ConfigClient.Conf.Veicoli.DanniVeicoli.degradingHealthSpeedFactor;
			cascadingFailureSpeedFactor = ConfigClient.Conf.Veicoli.DanniVeicoli.cascadingFailureSpeedFactor;
			degradingFailureThreshold = ConfigClient.Conf.Veicoli.DanniVeicoli.degradingFailureThreshold;
			cascadingFailureThreshold = ConfigClient.Conf.Veicoli.DanniVeicoli.cascadingFailureThreshold;
			engineSafeGuard = ConfigClient.Conf.Veicoli.DanniVeicoli.engineSafeGuard;
			torqueMultiplierEnabled = ConfigClient.Conf.Veicoli.DanniVeicoli.torqueMultiplierEnabled;
			limpMode = ConfigClient.Conf.Veicoli.DanniVeicoli.limpMode;
			limpModeMultiplier = ConfigClient.Conf.Veicoli.DanniVeicoli.limpModeMultiplier;
			preventVehicleFlip = ConfigClient.Conf.Veicoli.DanniVeicoli.preventVehicleFlip;
			sundayDriver = ConfigClient.Conf.Veicoli.DanniVeicoli.sundayDriver;
			displayMessage = ConfigClient.Conf.Veicoli.DanniVeicoli.displayMessage;
			compatibilityMode = ConfigClient.Conf.Veicoli.DanniVeicoli.compatibilityMode;
			randomTireBurstInterval = ConfigClient.Conf.Veicoli.DanniVeicoli.randomTireBurstInterval;
			classDamageMultiplier = ConfigClient.Conf.Veicoli.DanniVeicoli.classDamageMultiplier;
			tireBurstMaxNumber = randomTireBurstInterval * 1200;
			if (randomTireBurstInterval != 0)
				tireBurstLuckyNumber = Funzioni.GetRandomInt(tireBurstMaxNumber);
		}
