...
namespace TheLastPlanet.Client.GameMode.FREEROAM.Scripts.EventiFreemode
{
    public class FlyingUnderBridges : IWorldEvent
    {
        ...
        public async override void OnEventActivated()
        {
            ...
            HUD.ShowAdvancedNotification("Aircrafts of all kinds spotted all over Los Santos! Many ready for takeoff are at AILS.", "Fly By Intel", "From: Josef", "CHAR_JOSEF", "CHAR_JOSEF", HudColor.HUD_COLOUR_REDDARK, Color.FromArgb(255, 255, 255, 255), true, TipoNotifica.Mail);
