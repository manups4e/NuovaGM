...
namespace TheLastPlanet.Client.GameMode.ROLEPLAY.Interactions
{
    ...
    internal static class Televisions
    {
        ...
        public static async Task TVControls()
        {
            ...
            if (!TV.On && SittingAnimations.Seduto)
            {
            ...
            else if (TV.On && SittingAnimations.Seduto)
            {
