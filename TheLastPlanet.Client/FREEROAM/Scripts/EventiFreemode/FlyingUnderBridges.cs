...
namespace TheLastPlanet.Client.FreeRoam.Scripts.EventiFreemode
{
    public class FlyingUnderBridges : IWorldEvent
    {
        ...
        {
            {new Vector4(-1158.893f, -1738.877f, 4.055f,215.483f), VehicleHash.Buzzard },
            {new Vector4(-1168.874f, -1746.419f, 3.998f,124.725f), VehicleHash.Buzzard},
            ...
            {new Vector4(449.143f, -981.273f, 43.692f,90.059f), VehicleHash.Buzzard},
            ...
            {new Vector4(1769.635f, 3239.461f, 42.125f,280.808f), VehicleHash.Buzzard },
            ...
            {new Vector4(-745.328f, -1468.634f, 5.001f,142.71f), VehicleHash.Buzzard},
            ...
            {new Vector4(-252.804f, -2537.156f, 6.004f,158.885f),  VehicleHash.Buzzard},
            {new Vector4(313.394f, -1465.316f, 46.509f,43.926f), VehicleHash.Buzzard},
            {new Vector4(1175.107f, 278.744f, 81.871f,120.01f),  VehicleHash.Buzzard},
            {new Vector4(478.547f, -3370.131f, 6.07f,355.228f),  VehicleHash.Buzzard},
            ...
            {new Vector4(-1052.381f, -3493.217f, 14.143f,29.211f),VehicleHash.Buzzard },
