...
namespace TheLastPlanet.Client.IPLs.dlc_import_export
{
	public class ImportCEOGarage3
	{
		public class GaragePart
		{
			...
			public Garage Garage1 = new Garage(255489, "imp_sm_13_cargarage_a");
			public Garage Garage2 = new Garage(255745, "imp_sm_13_cargarage_b");
			public Garage Garage3 = new Garage(256001, "imp_sm_13_cargarage_c");
			public Garage ModShop = new Garage(256257, "imp_sm_13_modgarage");
