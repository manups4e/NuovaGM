...
namespace TheLastPlanet.Client.Core.Utility
{
	internal static class Eventi
	{
		...
		{
			Cache.GiocatoriOnline = await Client.Instance.SistemaEventi.Request<Dictionary<string, PlayerChar.User>>("lprp:callPlayers", Cache.MyPlayer.User.CurrentChar.Posizione);
