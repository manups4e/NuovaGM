...
namespace TheLastPlanet.Client.Core.Utility.HUD
{
	internal static class PauseMenu
	{
		...
		{
			PlayerChar.User pl = SessionCache.Cache.MyPlayer.User;
			...
			MainMenu = new TabView("The Last Planet", "Full RP") { SideStringTop = SessionCache.Cache.MyPlayer.Player.Name, SideStringMiddle = DateTime.Now.ToString(), SideStringBottom = "Portafoglio: $" + pl.Money + " Soldi Sporchi: $" + pl.DirtyMoney, DisplayHeader = true };
