...
namespace TheLastPlanet.Client.Core.Utility.HUD
{
	internal static class PauseMenu
	{
		...
		{
			PlayerChar.User pl = Cache.MyPlayer.User;
			...
			MainMenu = new TabView("The Last Planet", "Full RP") { SideStringTop = Cache.MyPlayer.Player.Name, SideStringMiddle = DateTime.Now.ToString(), SideStringBottom = "Portafoglio: $" + pl.Money + " Soldi Sporchi: $" + pl.DirtyCash, DisplayHeader = true };
