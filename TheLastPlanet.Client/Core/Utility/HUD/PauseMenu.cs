...
namespace TheLastPlanet.Client.Core.Utility.HUD
{
	internal static class PauseMenu
	{
		...
		private static async void LastPlanetMenu(Ped playerPed, object[] args)
		{
			...
			MainMenu = new TabView("The Last Planet", "Full RP") { SideStringTop = SessionCache.Cache.MyPlayer.Player.Name, SideStringMiddle = DateTime.Now.ToString(), SideStringBottom = "Portafoglio: $" + pl.Money + " Soldi Sporchi: $" + pl.DirtyCash, DisplayHeader = true };
