...
namespace TheLastPlanet.Client.Races.Creator
{
	static class RaceCreatorHelper
	{
		...
		public static string GetPropColor(int iParam0, int iParam1)
		{
			...
			else if (iParam0 == Funzioni.HashInt("sum_prop_ac_pit_sign_r_01a") || iParam0 == Funzioni.HashInt("sum_prop_ac_pit_sign_l_01a"))
			{
				switch (iParam1)
				{
					case 0:
			...
			else if (iParam0 == Funzioni.HashInt("xs_prop_arena_goal") || iParam0 == -296431790)
			{
				switch (iParam1)
				{
					case 1:
			...
			else if (iParam0 == Funzioni.HashInt("xs_prop_arena_goal_sf"))
			{
				switch (iParam1)
				{
					case 1:
			...
			else if (iParam0 == Funzioni.HashInt("xs_prop_arena_tower_02a"))
			{
				switch (iParam1)
				{
					case 1:
			...
			else if (iParam0 == Funzioni.HashInt("sr_prop_sr_track_jumpwall"))
			{
				switch (iParam1)
				{
					case 0:
			...
			else if (iParam0 == Funzioni.HashInt("xm_prop_x17_cover_01"))
			{
				switch (iParam1)
				{
					case 0:
