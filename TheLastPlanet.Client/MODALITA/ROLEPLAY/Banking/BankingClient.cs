...
namespace TheLastPlanet.Client.MODALITA.ROLEPLAY.Banking
{
	...
	{
		private static List<Position> _atmpos = new List<Position>() // DA DIVIDERE TRA FLEECA, MAZEBANK Ed eventuali 
		{
		...
		public static void Init()
		{
			...
			foreach (Position pos in _atmpos) atmInputs.Add(new InputController(Control.Context, pos, "Premi ~INPUT_CONTEXT~ per gestire il conto", new((MarkerType)(-1), pos, NativeUI.Colors.Transparent), ModalitaServer.Roleplay, PadCheck.Controller, action: new Action<Ped, object[]>(ApriConto)));
		...
		{
			ClosestATM = World.GetAllProps().Where(o => ATMs.Contains((ObjectHash)o.Model.Hash)).FirstOrDefault(o => Cache.PlayerCache.MyPlayer.Posizione.Distance(o.Position) < 1.5f);
					...
					case 1: // ritira
						switch (_currentSelection)
						{
							...
							case 7: // personalizzato
								string valore = await HUD.GetUserInput("Inserisci il valore che desideri ritirare", "", Cache.PlayerCache.MyPlayer.User.Bank.ToString().Length);
					...
					case 2: // deposita
						switch (_currentSelection)
						{
							...
							case 6: // 1000
								...
								break;
							case 7: // personalizzato
								string valore = await HUD.GetUserInput("Inserisci il valore che desideri depositare", "", Cache.PlayerCache.MyPlayer.User.Money.ToString().Length);
					...
					case 3: // GIROCONTO
						...
						switch (_currentSelection)
						{
							...
							case 6: // 1000
								...
								break;
							case 7: // personalizzato
								string valore = await HUD.GetUserInput("Inserisci il valore che desideri trasferire", "", Cache.PlayerCache.MyPlayer.User.Bank.ToString().Length);
