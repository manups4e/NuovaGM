...
namespace TheLastPlanet.Client.MODALITA.ROLEPLAY.Core.LogIn
{
	internal static class NewLogIn
	{
		...
		public static async void Attiva()
		{
			...
			await Cache.PlayerCache.Loaded();
			List<LogInInfo> data = await Client.Instance.Events.Get<List<LogInInfo>>("lprp:RequestLoginInfo", Cache.PlayerCache.MyPlayer.User.ID);
		...
		private static async void Selezionato(string data)
		{
			...
			*/
			...
			int switchType = GetIdealPlayerSwitchType(Cache.PlayerCache.MyPlayer.Ped.Position.X, Cache.PlayerCache.MyPlayer.Ped.Position.Y, Cache.PlayerCache.MyPlayer.Ped.Position.Z, Data.Posizione.X, Data.Posizione.Y, Data.Posizione.Z);
			...
			Cache.PlayerCache.MyPlayer.Ped.Position = Data.Posizione.ToVector3;
			Cache.PlayerCache.MyPlayer.Ped.Heading = Data.Posizione.Heading;
			...
			Position pos = await Data.Posizione.GetPositionWithGroundZ();
			Cache.PlayerCache.MyPlayer.Ped.Position = pos.ToVector3;
