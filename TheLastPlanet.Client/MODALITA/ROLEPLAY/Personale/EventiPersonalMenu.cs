...
*/
		...
		public static void Portiere(string portiera)
		{
			...
			else
			{
				...
				float distanceToVeh = Vector3.Distance(Cache.PlayerCache.MyPlayer.User.Posizione.ToVector3, vehicle.Position);
		...
		{
			if (!Cache.PlayerCache.MyPlayer.User.Status.RolePlayStates.InVeicolo) return;
