	...
	internal static class Creator
	{
		...
		public static void MenuCreazione(string nome, string cognome, string datadinascita, string sesso)
		{
			try
			{
				...
				Dettagli.InstructionalButtons.Add(button5);
