			...
			switch (iParam1)
			{
				...
				case 58:
					...
					else
					{
						...
						components[4] = 3;
						textures[4] = 11;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET001"));
				...
				case 60:
					if (isMale)
					{
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB8_0"));
					...
					else
					{
						...
						components[4] = 3;
						textures[4] = 7;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET011"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 1;
						textures[7] = 0;
				...
				case 61:
					if (isMale)
					{
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB5_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = 2;
						textures[4] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET006"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 2;
						textures[7] = 1;
				...
				case 62:
					...
					else
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_LOWR4"));
				...
				case 63:
					if (isMale)
					{
						...
						components[6] = 1;
						textures[6] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_TEETH1_0"));
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB0_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 0:
					if (isMale)
					{
						...
						components[6] = 12;
						textures[6] = 12;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_TEETH1_1"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 15;
						textures[8] = 0;
					...
					else
					{
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_LTS_F_JBIB_1_4"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 1:
					...
					else
					{
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB1_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_0"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 11;
						textures[6] = 1;
				...
				case 4:
					if (isMale)
					{
						...
						components[6] = 12;
						textures[6] = 12;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_TEETH1_2"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 5;
						textures[8] = 2;
				...
				case 6:
					...
					else
					{
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB1_1"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 7:
					...
					else
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_LTS_F_LEGS_0_1"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_PILOT_F_FEET_0_0"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 5;
						textures[7] = 4;
				...
				case 8:
					if (isMale)
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_LEGS0_2"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 10;
						textures[6] = 0;
						components[7] = 12;
						textures[7] = 2;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_ACCS0_0"));
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_JBIB2_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = 8;
						textures[4] = 4;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET0_3"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH0_3"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 13;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB4_8"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 9:
					if (isMale)
					{
						...
						components[4] = 4;
						textures[4] = 2;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET0_5"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH4_2"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 4;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB1_4"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 10:
					if (isMale)
					{
						...
						components[4] = 4;
						textures[4] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET0_7"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH4_2"));
						components[7] = Var1.drawable;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB1_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_LEGS0_0"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET1_2"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 7;
						textures[7] = 1;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB0_9"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 11:
					if (isMale)
					{
						...
						components[3] = 12;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_LEGS0_0"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 10;
						textures[6] = 0;
						components[7] = 0;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_ACCS1_0"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_JBIB0_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = 8;
						textures[4] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET0_4"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 6;
						textures[7] = 1;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_ACCS0_1"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB0_6"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 12:
					if (isMale)
					{
						...
						components[3] = 6;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_0"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET0_3"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
				...
				case 13:
					if (isMale)
					{
						...
						components[3] = 12;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_LEGS0_5"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 10;
						textures[6] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_JBIB0_5"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 6;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_LEGS1_8"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 0;
						textures[6] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB1_9"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 14:
					...
					else
					{
						...
						components[6] = 8;
						textures[6] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH1_0"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 5;
						textures[8] = 7;
				...
				case 15:
					if (isMale)
					{
						...
						components[6] = 10;
						textures[6] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_TEETH1_2"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_ACCS4_1"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_JBIB1_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 16:
					if (isMale)
					{
						...
						components[3] = 11;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_3"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET0_7"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 11;
						textures[7] = 2;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB9_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_6"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_FEET1_5"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_TEETH0_0"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_ACCS1_0"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB0_6"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 17:
					if (isMale)
					{
						...
						components[3] = 1;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_11"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET0_8"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_ACCS1_0"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB2_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 18:
					if (isMale)
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS1_4"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 1;
						textures[6] = 9;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_VAL_M_JBIB2_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_10"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_FEET1_10"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_TEETH0_2"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUS2_F_ACCS0_1"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB0_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 19:
					if (isMale)
					{
						...
						components[3] = 1;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_7"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET1_6"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_ACCS6_3"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB2_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 20:
					if (isMale)
					{
						...
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET0_3"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_TEETH0_3"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 15;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB5_4"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 6;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_2"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 3;
						textures[6] = 10;
						components[7] = 0;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_ACCS1_3"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB3_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 21:
					if (isMale)
					{
						...
						components[3] = 1;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_6"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET0_0"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_ACCS1_1"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB2_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_11"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_FEET1_4"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_TEETH0_3"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_ACCS1_6"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB4_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 22:
					if (isMale)
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_1"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 7;
						textures[6] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB11_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_7"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET0_1"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 4;
						textures[7] = 2;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_ACCS1_1"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
				...
				case 23:
					if (isMale)
					{
						...
						components[3] = 14;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_8"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET0_11"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_VAL_M_ACCS2_0"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB2_6"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = 0;
						textures[4] = 7;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET1_5"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH1_0"));
						components[7] = Var1.drawable;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB2_4"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 24:
					if (isMale)
					{
						...
						components[4] = 15;
						textures[4] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_FEET0_5"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_JBIB1_4"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 15;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS0_2"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET009"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 1;
						textures[7] = 2;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_JBIB2_10"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 25:
					if (isMale)
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_LOWR2_2"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 1;
						textures[6] = 3;
					...
					else
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_LOWR0"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 15;
						textures[6] = 1;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_TEETH0_1"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 3;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_JBIB1_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 26:
					if (isMale)
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_LOWR0_7"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_FEET0_6"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_JBIB1_5"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 11;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_LOWR107"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET008"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH1_2"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 3;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB5_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 27:
					if (isMale)
					{
						...
						components[3] = 15;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_LOWR2_11"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 5;
						textures[6] = 3;
					...
					else
					{
						...
						components[6] = 3;
						textures[6] = 13;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH1_1"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 3;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_JBIB2_9"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 28:
					if (isMale)
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_LOWR0_2"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_FEET0_8"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_TEETH1_1"));
						components[7] = Var1.drawable;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_JBIB1_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 29:
					if (isMale)
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_LOWR2_3"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_FEET0_4"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
					...
					else
					{
						...
						components[3] = 15;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_LOWR8"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET001"));
						components[6] = Var1.drawable;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_JBIB2_6"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 30:
					if (isMale)
					{
						...
						components[3] = 15;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_LOWR0_1"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 1;
						textures[6] = 7;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_TEETH0_1"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 15;
						textures[8] = 0;
					...
					else
					{
						...
						components[3] = 11;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_LOWR104"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET007"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 3;
						textures[7] = 1;
				...
				case 31:
					if (isMale)
					{
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB11_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_LOWR10"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_FEET003"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH0_0"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_ACCS0_4"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB0_5"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 32:
					if (isMale)
					{
						...
						components[3] = 12;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_LEGS0_5"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET1_10"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH0_12"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_ACCS3_13"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB1_5"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_LEGS0_4"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 0;
						textures[6] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB0_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 33:
					if (isMale)
					{
						...
						components[3] = 12;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_LEGS1_1"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 10;
						textures[6] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI2_M_JBIB2_1"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_LEGS1_4"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET0_0"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_TEETH0_0"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 2;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB3_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 34:
					if (isMale)
					{
						...
						components[3] = 11;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_LEGS0_7"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET0_2"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH4_10"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 6;
						textures[8] = 11;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB2_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[7] = 1;
						textures[7] = 1;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_ACCS2_5"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB0_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 35:
					if (isMale)
					{
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB5_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[7] = 6;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_ACCS0_3"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
				...
				case 36:
					if (isMale)
					{
						...
						components[6] = 11;
						textures[6] = 12;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH0_11"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 15;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB3_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = 7;
						textures[4] = 2;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET0_9"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 1;
						textures[7] = 1;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_ACCS1_3"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB4_10"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 37:
					if (isMale)
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_LEGS1_8"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET0_8"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 12;
						textures[7] = 2;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB0_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = 6;
						textures[4] = 2;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET1_7"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 6;
						textures[7] = 4;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_ACCS2_9"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
				...
				case 38:
					if (isMale)
					{
						...
						components[6] = 10;
						textures[6] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH4_14"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 4;
						textures[8] = 2;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB5_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = 7;
						textures[4] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET1_0"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 6;
						textures[7] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB1_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 39:
					if (isMale)
					{
						...
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET1_6"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH4_13"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 6;
						textures[8] = 12;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB2_9"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET0_8"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_TEETH0_2"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 2;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB3_4"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 45:
					if (isMale)
					{
						...
						components[7] = 0;
						textures[7] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_ACCS4_3"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
				...
				case 46:
					if (isMale)
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_M_LOWR2_1"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 9;
						textures[6] = 7;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB6_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 48:
					if (isMale)
					{
						...
						components[3] = 11;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_9"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET1_3"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 11;
						textures[7] = 2;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB7_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_LEGS1_0"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET1_9"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 6;
						textures[7] = 1;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB0_10"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 49:
					if (isMale)
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS2_2"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET1_14"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_TEETH0_4"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 15;
						textures[8] = 0;
					...
					else
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_5"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 8;
						textures[6] = 3;
				...
				case 50:
					if (isMale)
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_LEGS0_11"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET0_6"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH4_4"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 4;
						textures[8] = 1;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB1_0"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_13"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_FEET1_3"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_TEETH0_2"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_ACCS1_8"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB4_1"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 51:
					if (isMale)
					{
						...
						components[3] = 0;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS1_6"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 12;
						textures[6] = 15;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_VAL_M_JBIB2_1"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_8"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_FEET1_7"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH1_0"));
						components[7] = Var1.drawable;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB2_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 52:
					if (isMale)
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_LEGS0_12"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 10;
						textures[6] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH4_0"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_ACCS1_12"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB0_3"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
				...
				case 53:
					if (isMale)
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS2_12"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_FEET0_2"));
						components[6] = Var1.drawable;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_JBIB2_4"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 5;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_LEGS1_5"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET1_7"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH1_3"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 0;
						textures[8] = 15;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB0_8"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 54:
					if (isMale)
					{
						...
						components[3] = 12;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS1_1"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET1_10"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_TEETH1_6"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_ACCS1_6"));
						components[8] = Var1.drawable;
						textures[8] = Var1.texture;
						components[9] = 0;
						textures[9] = 0;
					...
					else
					{
						...
						components[3] = 12;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_LEGS2_9"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_FEET1_8"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BEACH_F_TEETH0_1"));
						components[7] = Var1.drawable;
						textures[7] = Var1.texture;
						components[8] = 3;
						textures[8] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_JBIB2_11"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
				...
				case 55:
					if (isMale)
					{
						...
						components[3] = 14;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_LEGS0_10"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_M_FEET1_8"));
						components[6] = Var1.drawable;
						textures[6] = Var1.texture;
						components[7] = 0;
						textures[7] = 0;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_M_JBIB1_2"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					else
					{
						...
						components[3] = 4;
						textures[3] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_BUSI_F_LEGS1_9"));
						components[4] = Var1.drawable;
						textures[4] = Var1.texture;
						components[6] = 8;
						textures[6] = 8;
						...
						components[10] = 0;
						textures[10] = 0;
						Var1 = ShopPed.GetShopPedComponent((uint)Game.GenerateHash("DLC_MP_HIPS_F_JBIB2_8"));
						components[11] = Var1.drawable;
						textures[11] = Var1.texture;
					}
					break;
