...
namespace TheLastPlanet.Client.AdminAC
{
	internal static class ClientManager
	{
		...
		private static async Task noClip()
		{
			...
			Entity target = p;
			if (Cache.PlayerCache.MyPlayer.User.Status.PlayerStates.InVeicolo) target = p.CurrentVehicle;
		...
		private static async void TeleportToMarker()
		{
			...
			if (blipFound)
			{
				...
				if (Cache.PlayerCache.MyPlayer.User.Status.PlayerStates.InVeicolo) ent = Cache.PlayerCache.MyPlayer.Ped.CurrentVehicle;
