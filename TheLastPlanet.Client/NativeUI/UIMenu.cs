...
namespace TheLastPlanet.Client.NativeUI
{
	...
	public class UIMenu
	{
		...
		private void DrawCalculations()
		{
			...
			BackgroundSize = Size > MaxItemsOnScreen + 1 ? new SizeF(431 + WidthOffset, 38 * (MaxItemsOnScreen + 1 + WindowHeight + CinematicHeight)) : new SizeF(431 + WidthOffset, 38 * Size + WindowHeight);
			_extraRectangleUp.Size = new SizeF(431 + WidthOffset, 18 + WindowHeight + CinematicHeight);
			_extraRectangleDown.Size = new SizeF(431 + WidthOffset, 18 + WindowHeight + CinematicHeight);
			_upAndDownSprite.Position = new PointF(190 + Offset.X + (WidthOffset > 0 ? (WidthOffset / 2) : WidthOffset), 147 + 37 * (MaxItemsOnScreen + 1) + Offset.Y - 37 + _extraYOffset + WindowHeight + CinematicHeight);
		...
		private void RecalculateDescriptionPosition()
		{
			...
			_descriptionRectangle.Position = new PointF(Offset.X, 149 - 37 + _extraYOffset + Offset.Y + WindowHeight + Cinematic);
			_descriptionText.Position = new PointF(Offset.X + 8, 155 - 37 + _extraYOffset + Offset.Y + WindowHeight + Cinematic);

			_descriptionBar.Size = new SizeF(431 + WidthOffset, 5);
		...
		public void ProcessMouse()
		{
			...
			for (int i = _minItem; i <= limit; i++)
			{
				...
				float ypos = Offset.Y + 144 - 37 + _extraYOffset + (counter * 38) + safezoneOffset.Y + WindowHeight + cinematic;
				float yposSelected = Offset.Y + 144 - 37 + _extraYOffset + safezoneOffset.Y + CurrentSelection * 38 + WindowHeight + cinematic;
			...
			float extraY = 144 + 38 * (MaxItemsOnScreen + 1) + Offset.Y - 37 + _extraYOffset + safezoneOffset.Y + WindowHeight + cinematic;
